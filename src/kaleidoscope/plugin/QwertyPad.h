...
class QwertyPad : public kaleidoscope::Plugin {
 public:
  QwertyPad(void) {}
 ...
 private:
  ...
  static KeyAddr qwertypadLayerToggleKeyAddr;
  static bool qwertypadActive;
};
}
}

extern kaleidoscope::plugin::QwertyPad QwertyPad;
